...
def guardar_datos():
    try:
        username = request.form.get('username')  # Usa `.get()` para evitar KeyError
        ...
        # Insertar datos
        query = "INSERT INTO User (nombre) VALUES (%s)"
        cursor.execute(query, (username,))  # La coma dentro del tuple es necesaria
